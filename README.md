...
- **耳机单击即时播报** — 跑步中支持通过蓝牙耳机的单击媒体键触发一次当前时间和跑步数据播报（已在真机验证）
...
5. **耳机单击媒体键**（设备支持时）→ 立即播报当前时间、当前距离、用时、当前心率、最大心率和配速
...
> "现在时间14点5分，当前已跑2.35公里，用时12分30秒，当前心率142，最大心率156，配速5分18秒每公里"
...
5. 每跑完 1 公里自动语音播报
6. （设备支持时）单击耳机媒体键，可随时触发一次包含当前时间的即时播报
7. 跑完后点"暂停跑步" → "结束本次"
